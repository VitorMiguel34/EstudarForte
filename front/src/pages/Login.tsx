...
import { type LoginData } from "../service/interfaces";
...
export default function LoginForm({setIsAuthenticated,}: LoginFormProps): React.JSX.Element {
    ...
    return (
        <div className="min-h-screen bg-black flex items-start justify-center px-6">
            <div
                data-aos="fade-down"
                className="mt-5 w-full max-w-md bg-zinc-900/70 backdrop-blur-md border border-zinc-800 rounded-2xl p-8 shadow-2xl"
            >
