...
export default function Sidebar(): React.JSX.Element {
    ...
    return (
        ...
        >
            {/* Logo */}
            <div
                className={`flex items-center mb-8 px-4 ${open ? "justify-between" : "justify-center"}`}
            >
            ...
            <nav className="flex flex-col gap-1 px-2.5">
              ...
              `}
                        >
                            ...
                            <Icon
                                className={`flex-shrink-0 w-4 h-4 transition-colors ${active ? "text-purple-300" : "text-purple-500 group-hover:text-purple-300"}`}
                            />
