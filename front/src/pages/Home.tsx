            ...
            <main>
                ...
                <section className="text-center px-6 pt-28 pb-20">
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto mb-8">
                        O espaço de trabalho moderno para anotações, planos de
                        estudo e acompanhamento de progresso.
                    </p>
                    ...
                    {[
                        {
                            ...
                            desc: "Organize matérias com tags e resumos.",
                        },
                        {
                            icon: "📅",
                            title: "Planejador de Estudos",
                            desc: "Crie cronogramas de estudo automáticos.",
                        },
                        {
                            icon: "📊",
                            title: "Acompanhamento de Progresso",
                            desc: "Visualize sua evolução com dashboards.",
                        },
                        {
                            icon: "🤝",
                            title: "Colaboração",
                            desc: "Estude com amigos e compartilhe materiais.",
                        },
                    ].map(({ icon, title, desc }) => (
                        <div
                            key={title}
        ...
        <div className="mr-10 w-full max-w-6xl mx-auto py-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <h3 className="text-2xl font-semibold mb-2">Seu Perfil</h3>
